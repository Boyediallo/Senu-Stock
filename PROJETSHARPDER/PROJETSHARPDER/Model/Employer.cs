...
namespace PROJETSHARPDER
{
    class Manoeuvres
    {
        ...
        public bool ajouterManoeuvre(string nom, string prenom, string telephone, string poste, string status, string salaire, string image)
        {
            MySqlCommand command = new MySqlCommand("INSERT INTO `manoeuvre`(`nom`, `prenom`, `telephone`, `poste`, `status`, `salaire`, `image`) VALUES (@nom,@prenom,@telephone,@poste,@status,@salaire,@image)", db.GetConnection);
        ...
        public bool modifierManoeuvre(int id, string nom, string prenom, string telephone, string poste, string status, string salaire, string image)
        {
            MySqlCommand command = new MySqlCommand("UPDATE `manoeuvre` SET `nom`=@nom,`prenom`=@prenom,`telephone`=@telephone,`poste`=@poste,`status`=@status,`salaire`=@salaire, `image`=@image WHERE `id`=@id", db.GetConnection);
